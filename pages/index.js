            ...
            <ul className="flex items-center">
              ...
              <li>
                <a
                  ...
                  href="https://drive.google.com/file/d/1MWEZk8tCH-lEDLMAlysmNScNjasDCLig/view"
                >
                  Resume
                </a>
              </li>
        ...
        <section className="py-10">
          ...
          <div className="flex flex-col gap-10 py-10 lg:flex-row lg:flex-wrap">
            <div className="basis-1/3 flex-1 ">
              <a href="https://travel-app-nextjs-gules.vercel.app">
                <Image
            ...
            <div className="basis-1/3 flex-1">
              <a href="https://food-order-app-react-mu.vercel.app">
                <Image
                  className="rounded-lg object-cover"
                  width={"100%"}
                  height={"100%"}
            ...
            <div className="basis-1/3 flex-1">
              <a href="https://real-estate-react-six.vercel.app">
                <Image
                  className="rounded-lg object-cover"
                  width={"100%"}
                  height={"100%"}
